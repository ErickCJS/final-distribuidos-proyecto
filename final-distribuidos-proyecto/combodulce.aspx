<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/maestra-empresa.Master" CodeBehind="combodulce.aspx.vb" Inherits="AplicacionWebCine.combodulce" %>
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="table-responsive" style="height: 300px; overflow-y: auto;">
                                        <table class="table table-hover table-bordered" >
                                            ...
                                            <tbody>
                                                <asp:PlaceHolder ID="phCombodulce" runat="server">
